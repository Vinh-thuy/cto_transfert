...
openai_api_key = "sk-proj-zrA4zBQ285cK3jp_kbh2US9LMmxWDYJyUmkScYncg8FsRn_lWQHgjsyPicp4XS6JqqT6T3BlbkFJPfvdcrJhjIC7KAIjtUovFiL3sG9fzPD1mmsobN6VWKRFdTCBaqKncRKeblkcC_NODltBp4HqEA"
...
def test_agent():
    logging.info("\n\n=== DÉBUT DU TEST DE L'AGENT AVEC L'OUTIL DE GÉNÉRATION DE TITRES ===")
    ...
    logging.info("=== FIN DU TEST DE L'AGENT AVEC L'OUTIL DE GÉNÉRATION DE TITRES ===\n\n")
    return state
